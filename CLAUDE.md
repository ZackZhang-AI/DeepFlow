...
- **Model assignment per Agent** is configured via env vars: `PLANNER_MODEL`, `RESEARCHER_MODEL`, `REPORTER_MODEL`, `REPORTER_FALLBACK_MODEL`. Defaults to `deepseek-v4-flash` for Planner/Researcher and `deepseek-v4-pro` for standard/deep Reporter.
